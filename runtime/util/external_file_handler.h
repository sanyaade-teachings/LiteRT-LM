...
#ifndef THIRD_PARTY_ODML_LITERT_LM_RUNTIME_UTIL_EXTERNAL_FILE_HANDLER_H_
#define THIRD_PARTY_ODML_LITERT_LM_RUNTIME_UTIL_EXTERNAL_FILE_HANDLER_H_
...
#endif  // THIRD_PARTY_ODML_LITERT_LM_RUNTIME_UTIL_EXTERNAL_FILE_HANDLER_H_
